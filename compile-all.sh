...
g++ main.cpp -o hexapod-fast        -std=c++11 -Ofast -march=native -fopenmp -D_GLIBCXX_PARALLEL -floop-block -floop-strip-mine -floop-interchange -funroll-loops -mfloat-abi=hard -mfpu=neon 
g++ main.cpp -o hexapod             -std=c++11 -O3    -march=native -fopenmp -D_GLIBCXX_PARALLEL -floop-block -floop-strip-mine -floop-interchange -funroll-loops -mfloat-abi=hard -mfpu=neon 
